    ...
    <div className={cn('flex items-center gap-2.5', className)}>
      ...
      >
        ...
        >
          ...
          <rect x="15" y="17" width="5" height="15" rx="1.5" fill="white" opacity="0.8" />
          ...
          <defs>
            <linearGradient id="rfm-bg-gradient" x1="0" y1="0" x2="40" y2="40" gradientUnits="userSpaceOnUse">
  ...
  return (
    ...
    >
      ...
      >
        ...
        <defs>
          <linearGradient id="rfm-icon-bg-gradient" x1="0" y1="0" x2="40" y2="40" gradientUnits="userSpaceOnUse">
            <stop stopColor="#22c55e" />
            <stop offset="0.5" stopColor="#16a34a" />
            <stop offset="1" stopColor="#15803d" />
          </linearGradient>
