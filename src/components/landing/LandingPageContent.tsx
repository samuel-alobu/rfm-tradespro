        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
              Join RFM TradePro today and access powerful trading tools, expert insights, and a community of successful traders across stocks, crypto, forex, and real estate.
            </p>
