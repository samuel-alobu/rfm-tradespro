...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    content: "RFM Trades Pro has everything you could ask for, I'm super happy it has been recommended to me as my first broker",
    rating: 5,
  },
  {
    id: 6,
    ...
    <div className={cn('relative', className)}>
      ...
      >
        ...
        <p className="text-lg text-white/60 max-w-2xl mx-auto">
          Thousands of forward-thinking users rely on RFM Trades Pro everyday to
