    ...
    faqs: [
      {
        ...
        answer: 'RFM TradePro offers access to 500+ tradeable assets across multiple markets: 200+ cryptocurrencies (Bitcoin, Ethereum, etc.), 80+ forex pairs (major, minor, and exotic), 15,000+ global stocks and ETFs, commodities (gold, silver, oil, etc.), and indices (S&P 500, NASDAQ, etc.).',
      },
      {
        ...
        <section className="py-16 px-6 bg-[#0f1419]">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-[#6b7a90] mb-8">
              Find answers to common questions about RFM TradePro
            </p>
