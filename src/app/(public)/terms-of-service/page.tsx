          ...
          <div className="max-w-4xl mx-auto prose prose-invert prose-green">
            <div className="space-y-8 text-[#9ca3af]">
              ...
              <div className="bg-[#0f1419] rounded-xl p-6 border border-[#f59e0b]/30">
                ...
                <p className="text-sm">
                  Please read these Terms of Service carefully before using RFM TradePro. 
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  ...
                  you ("User," "you," or "your") and RFM TradePro, Inc. ("Company," "we," 
                  "us," or "our") governing your access to and use of the RFM TradePro 
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  ...
                  are owned by RFM TradePro or its licensors. You may not use, copy, 
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  You agree to indemnify, defend, and hold harmless RFM TradePro, its 
              ...
              <div>
                ...
                <div className="bg-[#0f1419] rounded-xl p-6 mt-4 border border-[#1e2733]">
                  <p className="text-white font-semibold mb-2">RFM TradePro Legal Department</p>
                  <p>Email: legal@eliteprocapital.com</p>
