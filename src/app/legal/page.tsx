...
const legalDocuments = [
  {
    ...
    description:
      "The terms and conditions governing your use of RFM TradePro services.",
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-[#6b7a90] max-w-2xl mx-auto">
                RFM TradePro operates under strict regulatory oversight in
