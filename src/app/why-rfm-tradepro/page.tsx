...
const testimonials = [
  {
    quote: "I've tried multiple platforms, but RFM TradePro's execution speed is unmatched. My scalping strategy finally works as intended.",
    author: "Michael R.",
  ...
  {
    quote: "As a developer, I appreciate the robust API. Building my trading bots on RFM TradePro was seamless.",
    author: "Kenji T.",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#0f1419] rounded-xl border border-[#1e2733] overflow-hidden">
              <div className="grid grid-cols-3 bg-[#1e2733] p-4">
                ...
                <div className="text-[#22c55e] font-semibold text-center">RFM TradePro</div>
        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-[#6b7a90] leading-relaxed mb-8">
              RFM TradePro operates under strict regulatory oversight. We're registered 
        ...
        <section className="py-20 px-6 bg-gradient-to-r from-[#22c55e]/10 to-[#16a34a]/10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-[#6b7a90] mb-8">
              Join thousands of traders who've already made the switch to RFM TradePro.
            </p>
